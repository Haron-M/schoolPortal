...
SECRET_KEY = 'django-insecure-5=-qh&b70noyib8oqi-spgqm(3ga2-wv97if20&jakuch%r#ax'
...
STATIC_URL = 'static/'
# Tell Django to find static assets inside your apps
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'elearning_portal', 'static'),
]
